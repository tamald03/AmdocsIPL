...
CREATE TABLE `ground` (
  `ground_id` varchar(10) NOT NULL,
  `ground_name` varchar(100) NOT NULL,
  `ground_location` varchar(100) DEFAULT NULL,
...
INSERT INTO `ground` VALUES ('G001','Wankhede Stadium','Mumbai'),('G002','Eden Gardens','Kolkata'),('G003','M. Chinnaswamy Stadium','Bangalore'),('G004','Narendra Modi Stadium','Ahmedabad');
